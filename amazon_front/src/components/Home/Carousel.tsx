...
import Image1 from "../../assets/images/im-4.webp"
import Image2 from "../../assets/images/im-5.webp"
import Image3 from "../../assets/images/im-6.webp"
            ...
            <Slider adaptiveHeight={true} responsive={responsive} className="">
                <div>
                    <Link to="/product/6532112c35ca026efd058444">
                        <img className="bg-no-repeat carousel-img" src={Image1} alt="img1" />
                    </Link>
                </div>
                <div>
                    <Link to="/product/65433425ff2dd51bb661f308">
                        <img className="bg-no-repeat carousel-img" src={Image2} alt="img4" />
                    </Link>
                </div>
                <div>
                    <Link to="/">
                        <img className="bg-no-repeat carousel-img" src={Image3} alt="img3" />
                    </Link>
                </div>
                {/* <div>
                ...
                {/* <div>
                    <Link target="_black" to="https://www.primevideo.com/detail/Adipurush/0JIHKJ9VD04K1S5CAGG2QB7PBO">
                        <img className="bg-no-repeat carousel-img" src={Image3} alt="img5" />
                    </Link>
                </div> */}
            </Slider>
        </div>
